...
# form for raising issue
class IssueForm(forms.Form):
    # entries required in the form
    id = forms.CharField(max_length=50, label='Registration number/ employee id',
                         widget=forms.TextInput(attrs={'placeholder': 'Reg Number/Employee Id'}))
    ...
    description = forms.CharField(widget=forms.Textarea(
        attrs={"rows": 10, "cols": 40, "placeholder": "Explain your issue, so that it is easy for us to help you"}))
